<div id="post-menu-body">
    <div id="content-container">
        ...
        <p>A new feature allows users to subscribe to push notifications to receive notices when vessels are nearing Clinton for viewing. There are two groups with different expected notice frequency.  The Passenger Vessels notice stream will give you five notices for each vessel, but such vessels arrive only a few times per month. The All Vessels notice stream limits alerts on each vessel to two, but with so much tow traffic there may be a dozen per day. There is no cost for the service and it requires giving no personal data. Activate it and get more details on the Alerts page. If you accidentally choose the wrong list, delete our site from your web browser's notification's settings, then choose the correct one to reactivate.</p>
        <h2>Other Features?</h2>
        <p>This site will grow as it gets used and more vessel passages are logged. Improvement for display on mobile phones is on the way. We invite your comments and suggestions for improvements. Contact us at the email address below.</p>
