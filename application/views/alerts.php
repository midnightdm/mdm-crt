...
</a> link in your favorite news reader software to get updates when vessels are near.</p>
<div class="button_cont"><a class="example_c" href="" onclick="requestAllNotifications()">Get All Vessel Notifications!</a></div>
