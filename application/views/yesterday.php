<ul class="nav">
  ...
  <li><a class="nav-link selected" href="yesterday">Yesterday</a></li>
  <li><a class="nav-link" href="past7days">Past 7 Days</a></li>
</ul>
<h1><?php echo $subtitle; ?></h1>
<h3><?php echo $range; ?></h3>
<p>This log shows the time each vessel passed the rail road drawbridge at Clinton, Iowa, Lock and Dam 13 at Fulton, Illinois and whether it was traveling upriver or downriver.</p>
<table>
