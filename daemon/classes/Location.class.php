...
class ZONE {
 ...
 class Location {
    ...
    public function setPoint() {
        $this->point = new Point($this->live->liveLastLon, $this->live->liveLastLat);
    }
    ...
    public function calculate() {
        ...
        $urange = [495,496,497,498,499,500,501,502,503,504,505,506,507,508,509,510,511,512,513,514,515,516,517,518,519,520,521,522,523,524,525,526,527,528,529,530,531,532,533,534,535,536,537,538,539,540];
        $drange = [540,539,538,537,536,535,534,533,532,531,530,529,528,527,526,525,524,523,522,521,520,519,518,517,516,515,514,513,512,511,510,509,508,507,506,505,504,503,502,501,500,499,498,497,496,495];
        $range  = $this->live->liveDirection=="upriver" ? $urange : $drange;
        $this->setPoint();
        foreach($range as $m) {
            //Skip previously crossed lines
            if($this->live->liveDirection=="upriver") {
               if($m<=$this->mm) { continue; }    
